  ...
  return (
    <>
      <div className='px-[16px] w-screen h-screen overflow-scroll pb-[62px]'>
        ...
        {/* 토글버튼 */}
        <div className='flex justify-end items-center mt-[16.5px] gap-[8px] mb-[4px]'>
        ...
        {/* 대결 목록 */}
        <div className='flex gap-[16px] items-center py-[16px] mt-[12px]'>
          <div>
            <svg
              width='48'
              height='48'
              ...
              xmlns='http://www.w3.org/2000/svg'
            >
              <g clip-path='url(#clip0_782_4069)'>
                <g clip-path='url(#clip1_782_4069)'>
                  <path
                    d='M24.0528 48.1057C37.3369 48.1057 48.1057 37.3369 48.1057 24.0528C48.1057 10.7688 37.3369 0 24.0528 0C10.7688 0 0 10.7688 0 24.0528C0 37.3369 10.7688 48.1057 24.0528 48.1057Z'
                    fill='#050409'
                  />
                  <mask
                    id='mask0_782_4069'
                  ...
                  <g mask='url(#mask0_782_4069)'>
                    <path
                      d='M6.79883 42.9538C6.79883 42.9538 7.78965 11.8066 32.0054 11.8066C56.2212 11.8066 51.9144 49.6254 51.9144 49.6254L24.4311 53.549L6.79883 42.9494'
                      fill='#6E7487'
                    />
                    <mask
                      id='mask1_782_4069'
                    ...
                    <g mask='url(#mask1_782_4069)'>
                      <path
                        d='M19.8867 15.1757L25.6643 16.3823L27.6988 14.797L27.7649 16.2326L31.2658 16.3823L31.8251 14.9863L32.2522 16.4351L36.5194 16.1973L36.6119 14.6076L38.5935 16.1841L43.6665 15.9948L36.4225 9.57422L27.6548 9.6667L21.7979 14.0792'
                        fill='#3D404A'
                      />
                    </g>
                  </g>
                  <path
                    d='M25.3298 27.308C26.0351 27.308 26.6069 26.7363 26.6069 26.031C26.6069 25.3257 26.0351 24.7539 25.3298 24.7539C24.6245 24.7539 24.0527 25.3257 24.0527 26.031C24.0527 26.7363 24.6245 27.308 25.3298 27.308Z'
                    fill='black'
                  />
                  <path
                    d='M30.9763 27.308C31.6816 27.308 32.2533 26.7363 32.2533 26.031C32.2533 25.3257 31.6816 24.7539 30.9763 24.7539C30.271 24.7539 29.6992 25.3257 29.6992 26.031C29.6992 26.7363 30.271 27.308 30.9763 27.308Z'
                    fill='black'
                  />
                  <path
                    d='M25.3301 30.1395C25.7969 30.778 26.431 31.4914 26.9418 31.3593C27.6332 31.1788 27.6552 29.8357 28.0604 29.8357C28.5007 29.8357 28.6416 31.465 29.2361 31.5531C29.6369 31.6103 30.1169 30.8045 30.5748 29.7344'
                    stroke='black'
                    stroke-miterlimit='10'
                    stroke-linecap='round'
                  />
                  <path
                    d='M17.1788 32.9396C18.8837 32.9396 20.2657 31.5575 20.2657 29.8526C20.2657 28.1477 18.8837 26.7656 17.1788 26.7656C15.4739 26.7656 14.0918 28.1477 14.0918 29.8526C14.0918 31.5575 15.4739 32.9396 17.1788 32.9396Z'
                    fill='#3D404A'
                  />
                  <path
                    d='M38.7256 32.6935C40.4305 32.6935 41.8126 31.3114 41.8126 29.6065C41.8126 27.9016 40.4305 26.5195 38.7256 26.5195C37.0208 26.5195 35.6387 27.9016 35.6387 29.6065C35.6387 31.3114 37.0208 32.6935 38.7256 32.6935Z'
                    fill='#3D404A'
                  />
                  <path
                    d='M31.6631 11.5852C33.6258 11.5852 35.2169 10.1893 35.2169 8.46741C35.2169 6.7455 33.6258 5.34961 31.6631 5.34961C29.7004 5.34961 28.1094 6.7455 28.1094 8.46741C28.1094 10.1893 29.7004 11.5852 31.6631 11.5852Z'
                    fill='#3D404A'
                  />
                  <path
                    d='M33.2255 11.1719H30.0945C29.8902 11.1719 29.7246 11.3375 29.7246 11.5418V11.6343C29.7246 11.8386 29.8902 12.0042 30.0945 12.0042H33.2255C33.4298 12.0042 33.5954 11.8386 33.5954 11.6343V11.5418C33.5954 11.3375 33.4298 11.1719 33.2255 11.1719Z'
                    fill='#050508'
                  />
                </g>
              </g>
              <defs>
                <clipPath id='clip0_782_4069'>
                  <rect width='48' height='48' fill='white' />
                </clipPath>
                <clipPath id='clip1_782_4069'>
                  <rect width='48' height='48' fill='white' />
                </clipPath>
              </defs>
            </svg>
          ...
          <div className='text-[#BEBDC4] text-[16px] leading-[22px] font-medium'>
            <div>
              <span className='text-[#FEFEFE] font-bold'>김코끼리</span>
              님과 대결!
            </div>
        ...
        <div className='flex gap-[16px] items-center py-[16px] mt-[12px]'>
          ...
          <div className='text-[#BEBDC4] text-[16px] leading-[22px] font-medium'>
            <div>
              <span className='text-[#FEFEFE] font-bold'>최나무</span>
              님과 대결!
            </div>
            <div className='flex mt-[8px]'>
              <div className='mr-[4px]'>
        ...
        <div className='flex gap-[16px] items-center py-[16px] mt-[12px]'>
          ...
          <div className='text-[#BEBDC4] text-[16px] leading-[22px] font-medium'>
            <div>
              <span className='text-[#FEFEFE] font-bold'>정재진</span>
              님과 대결!
            </div>
            <div className='flex mt-[8px]'>
              <div className='mr-[4px]'>
        ...
        <div className='flex gap-[16px] items-center py-[16px] mt-[12px]'>
          ...
          <div className='text-[#BEBDC4] text-[16px] leading-[22px] font-medium'>
            <div>
              <span className='text-[#FEFEFE] font-bold'>홍기러기</span>
              님과 대결!
            </div>
            <div className='flex mt-[8px]'>
              <div className='mr-[4px]'>
        ...
        <div className='flex gap-[16px] items-center py-[16px] mt-[12px]'>
          ...
          <div className='text-[#BEBDC4] text-[16px] leading-[22px] font-medium'>
            <div>
              <span className='text-[#FEFEFE] font-bold'>민호랑이</span>
              님과 대결!
            </div>
            <div className='flex mt-[8px]'>
              <div className='mr-[4px]'>
