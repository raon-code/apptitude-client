...
export default function Nav() {
    ...
    return (
        <nav className="flex justify-between absolute bottom-0 w-full bg-[#333333] rounded-t-[20px]">
            <Link to={'/'} className={cls(`pb-[7px] pt-[10px] w-full h-full relative`, mainMatch ? 'fill-[#04C357] text-[#04C357]' : 'fill-[#FEFEFE] opacity-[0.6] text-[#FEFEFE]')}>
