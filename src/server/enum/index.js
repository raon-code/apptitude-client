...
import { GENDER, GENDER_MAP } from '@/server/enum/gender';
import { JOB_TYPE, JOB_TYPE_MAP } from '@/server/enum/job-type';
import {
  MESSAGE_TYPE,
  MESSAGE_TYPE_MAP
} from '@/server/enum/message-type';
import { OS_TYPE, OS_TYPE_MAP } from '@/server/enum/os-type';
import {
  PLATFORM_TYPE,
  PLATFORM_TYPE_MAP
} from '@/server/enum/platform-type';
import { QUOTE, QUOTE_MAP } from '@/server/enum/quote';
import {
  RESULT_TYPE,
  RESULT_TYPE_MAP
...
export { ENUM_LIST, ENUM_MAP_LIST };
